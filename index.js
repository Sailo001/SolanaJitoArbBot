...
const dexPrograms = {
  ...
  Lifinity:"EeoK99iD1xRWmER9sEz4m6FxAf8x1gU2wV2s"             // optional
};
    ...
    try {
      ...
      for (const acc of accounts) {
        ...
        try {
          ...
          // assume USDC is quote (lower address)
...
console.log("🤖 Meme-coin on-chain arbitrage bot started (Raydium + Orca + Lifinity)...");
