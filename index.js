...
async function loadTokens() {
  try {
    ...
    allTokens = data.tokens.filter(
      (t) => t.symbol !== QUOTE_TOKEN && t.chainId === 101 && t.decimals <= 9
    );
...
// DEX programs (on-chain)
const dexPrograms = {
  Raydium: "RVKd61ztZW9xAq6e9kGp22...", // Raydium AMM
  Orca: "whirLbEe...", // Orca Whirlpool
  Lifinity: "3rZtsW5GvV9f8Zp4P2...", // Lifinity
};
...
http
  .createServer((req, res) => {
    ...
    res.end("✅ On-chain dynamic arbitrage bot running\n");
  })
...
console.log(
  "🤖 On-chain dynamic meme coin arbitrage bot started (Raydium + Orca + Lifinity)..."
);
sendTelegramMessage(
  `✅ Bot deployed: scanning all tokens on-chain for arbitrage + real-time PnL!`
);
