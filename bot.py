...
COINGECKO_IDS = {
    ...
    '7yN93TFSCZqMJD3c7C3jVjdG61bsoN1mB6YntpgtM5tV': 'floki',  # FLOKI
    '7WduG7udFvAJK8g7n2r2XbHSwYfXh2xN4V17J2S7Nq15': 'cat-in-a-dogs-world'  # MEW
}
                ...
                if ray_price is None:
                    ...
                    return {
                        ...
                        'jup_quote': {
                            ...
                            'token_to_usdc': quote2 if CYCLE_TYPE == 'direct' and quote3 is not None else None
                        },
                        'ray_price': None,
