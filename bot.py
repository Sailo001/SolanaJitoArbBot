...
POLL_INTERVAL = int(os.getenv('POLL_INTERVAL', 15))  # Reduced for faster scans
...
COINGECKO_IDS = {
    '13hwbtDPhx6G4sN4kJ6LTJD4b1bYqWbQdd426FXDMddY': 'wall-street-pepe',
    '4fYvhTHCPfaS4QixrKrrcQAxqAUYRfJbeGURJEwmPUMP': 'bitcoin-hyper',
    'DMXoGAd9Xkdn6uko2AiKEczJicHDyobBpASMPMRPjL2z': 'snorter-bot',
    '333qufn42Vx8fgLS23uG87BMXmn8BtjfURTheZ7xJR6X': 'subbd',
    '8XsAAThxEuh2SRpmQjJoyqS1oDDu92sNCfeo55Zd5SPY': 'spacepay',
    '2zMM7o5AMQQkgsXFEQbP9kDMyN5r2v5r8jZ9kDMyN5r': 'pengu'
}
...
class ArbDetector:
    ...
    async def scan(self):
        self.load_tokens()  # Reload tokens for dynamic updates
        ...
        async with aiohttp.ClientSession() as session:
            ...
            for sym, info in self.tokens.items():
                ...
                tasks.append(task)
                await asyncio.sleep(random.uniform(1.0, 2.0))  # Faster stagger
            try:
