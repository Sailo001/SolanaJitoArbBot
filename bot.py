...
PRICE_DIFF_PCT = float(os.getenv('PRICE_DIFF_PCT', 0.5))
...
# Map token addresses to CoinGecko IDs for fallback
COINGECKO_IDS = {
    ...
    '7WduG7udFvAJK8g7n2r2XbHSwYfXh2xN4V17J2S7Nq15': 'cat-in-a-dogs-world',
    '6dKCoWjcqLqS1ph25ANP66Y3s7TCCfJ46r3NoW3a2ZrH': 'shiba-inu'
}
...
class ArbDetector:
    ...
    async def get_coingecko_price(self, session, token_address):
